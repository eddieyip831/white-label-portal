...
begin
  ...
  -- Insert user profile
  insert into public.user_profile (id, full_name, tenant_id, tier_id)
  values (v_user_id, new.raw_user_meta_data->>'full_name', v_tenant_id, v_free_tier)
